		...
		<div class="row">
			...
			<div class="col-md-9">
				<table class="table table-striped">
					...
					<tbody>
						<%
					if (request.getAttribute("myClasses") != null) {
						List<GymClass> classes = (List<GymClass>)request.getAttribute("myClasses");
					...
					%>
						<tr>
							...
							<th>
								<a href="dropClass?classId=<%=gymclass.getId() %>" class="btn btn-danger">Drop Class</a>
							</th>
						</tr>
						<%}} %>
					</tbody>
